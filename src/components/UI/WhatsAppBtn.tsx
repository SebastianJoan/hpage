...
export default function WhatsAppBtn() {
  return (
    <>
      <Link href={`https://wa.me/+12812209292`} target='blanck' className='hidden md:flex  w-[65px] h-[65px] bg-green-500 text-white absolute bottom-10 right-10 z-20 rounded-full shadow-md shadow-black p-2'>
          <Image
              alt='whatsapp icon'
              src={whatsapp_icon}
